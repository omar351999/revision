...
// to continue in frist loop or not
...
// to continue in second loop or not
...
int main() {
	...
	// loop for choose system
	do {
		
		//  show all systems and ask to input one odf them
		Choose_System();
		cout << "Your choose: ";
		cin >> system_number;

		// check if the number of system is valid
		...
		// print the system that user choose
		System_Choosen(system_number);

		bool new_operation = true;
		int operation_number;

		// loop for choose operation
		do
		{
			// choose the operation that U want to do in choosen system
			Choose_Operation(); 
			...
			// print the operation that user choose
